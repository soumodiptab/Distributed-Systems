...
hadoop jar $JAR_FILE -files mapper2.py,reducer2.py -mapper 'python3 mapper2.py' -reducer "python3 reducer2.py $ROWS $COLS" -input $HDFS_INPUT_DIR -output $HDFS_OUTPUT_DIR
